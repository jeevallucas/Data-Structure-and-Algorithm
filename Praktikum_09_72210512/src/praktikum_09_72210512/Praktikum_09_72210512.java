...
public class Praktikum_09_72210512 extends Application {
    ...
    private void tableInitialization() {
        ...
        animeTitleColumn.setStyle("-fx-alignment: CENTER_LEFT;");
    ...
    private void save() {
        ...
        try {
            ...
            Logger.getLogger(Praktikum_09_72210512.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    void search() {
        ...
        if (index < amount) {
            ...
            Alert a = new Alert(Alert.AlertType.INFORMATION, "Anime with the title '" + animeTitleSearch + "' was found.");
            a.show();
        } else {
            Alert a = new Alert(Alert.AlertType.WARNING, "Anime with the title '" + animeTitleSearch + "'  was not found.");
            a.show();
        }
    }
    ...
    public void start(Stage primaryStage) throws Exception {
        this.file = new TextFile("src/praktikum_09_72210512/Anime.csv");
