...
public class Praktikum_07_72210512 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        grid.add(lblGrup, 0, 6);
        grid.add(txtGrup, 1, 6);
        grid.add(lblKetGrup, 2, 6);
        ...
        btnSave.setOnAction((ActionEvent event) -> {
            ...
            try {
                ...
                Logger.getLogger(Praktikum_07_72210512.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
        ...
        btnTop.setOnAction((ActionEvent event) -> {
            dafMhs.moveFirst();
            tampil();
        });
